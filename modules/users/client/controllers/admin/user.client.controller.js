...
(function () {
  ...
  AdminPanelController.$inject = ['$scope', '$state', '$window', 'Authentication', 'Notification'];

  function AdminPanelController($scope, $state, $window, Authentication, Notification) {
    var vm = this;
